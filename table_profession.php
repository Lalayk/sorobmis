                ...
                <table>
                    ...
                    if (isset($_GET['filter'])) {
                        ...
                        if ($filter == 'all') {
                            ...
                            $result = $conn->query("SELECT * FROM accounts WHERE type = 'helper' OR type = 'client' ORDER BY profession");
                            ...
                            $result = $conn->query("SELECT * FROM accounts WHERE profession = 'Carpenter' ORDER BY profession");
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>{$row['type']}</td>";
                                echo "<td>{$row['profession']}</td>";
                            ...
                            $result = $conn->query("SELECT * FROM accounts WHERE profession = 'Electrician' ORDER BY profession ");
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>{$row['type']}</td>";
                                echo "<td>{$row['profession']}</td>";
                            ...
                            $result = $conn->query("SELECT * FROM accounts WHERE profession = 'Beautician' ORDER BY profession ");
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>{$row['type']}</td>";
                                echo "<td>{$row['profession']}</td>";
                            ...
                            $result = $conn->query("SELECT * FROM accounts WHERE profession = '-' ORDER BY profession");
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>{$row['type']}</td>";
                                echo "<td>{$row['profession']}</td>";
